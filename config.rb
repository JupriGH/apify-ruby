...
class Configuration
	...
	def initialize
		...
		#@api_base_url = api_base_url or getenv(ApifyEnvVars::API_BASE_URL, 'https://api.apify.com')
		@api_public_base_url 			= getenv(ApifyEnvVars::API_PUBLIC_BASE_URL, 'https://api.apify.com')
		#@chrome_executable_path = getenv(ApifyEnvVars::CHROME_EXECUTABLE_PATH)
		#@container_port = container_port or getenv(ActorEnvVars::WEB_SERVER_PORT, 4321)
		#@container_url = container_url or getenv(ActorEnvVars::WEB_SERVER_URL, 'http://localhost:4321')
