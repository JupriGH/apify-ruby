...
module Apify
	...
	class ApifyClient
		...
		def initialize token=nil, api_url: nil, max_retries: 8, min_delay_between_retries_millis: 500, timeout_secs: 360
			...
			@_options = { root_client: self, base_url: @base_url, http_client: @http_client }
		end
		...
		def key_value_store(key_value_store_id) = KeyValueStoreClient.new resource_id: key_value_store_id, **@_options
